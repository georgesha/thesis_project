...
train_sequence = ImageSequence(
    dataset_csv_file="",
    class_names=["No Finding", "Enlarged Cardiomediastinum", "Cardiomegaly", "Lung Opacity", "Lung Lesion", "Edema", "Consolidation",
...
x = model.output
predictions = Dense(14, activation="sigmoid", name="output")(x)
...
# train
filepath = "models/weights.densenet_chexpert_lat.hdf5"
...
auroc = MultipleClassAUROC(
    ...
    class_names=["No Finding", "Enlarged Cardiomediastinum", "Cardiomegaly", "Lung Opacity", "Lung Lesion", "Edema", "Consolidation",
                 "Pneumonia", "Atelectasis", "Pneumothorax", "Pleural Effusion", "Pleural Other", "Fracture", "Support Devices"],
    weights_path="models/weights.densenet_chexpert_lat.hdf5"
)
